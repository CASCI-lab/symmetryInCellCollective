...
new = pd.read_csv("./data/cc-ks-n_0-k_0-PI_0-timeout_2-version_new.csv")
old = pd.read_csv("./data/cc-ks-n_0-k_0-PI_0-timeout_2-version_v0.1.2.csv")
data = pd.concat(
	[new, old],
	ignore_index=True
)
...
axes[1].boxplot([x for x in speedups if not np.isnan(x)])
axes[1].set_yscale("log")
axes[1].set_ylabel("Times Speedup", fontsize=22)
